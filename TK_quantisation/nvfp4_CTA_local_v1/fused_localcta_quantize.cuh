...
using IType3D = IType
    [tk_localcta::BUFFS_NUM_IN]
    [tk_localcta::BUFF_DIM_Y]
    [tk_localcta::BUFF_DIM_X];
template <int PIPE_DEPTH>
using ITypeRing4D = IType
    [PIPE_DEPTH]
    [tk_localcta::BUFFS_NUM_IN]
    [tk_localcta::BUFF_DIM_Y]
    [tk_localcta::BUFF_DIM_X];
using IType2x3D = IType2
    [tk_localcta::BUFFS_NUM_IN]
    [tk_localcta::BUFF_DIM_Y]
    [tk_localcta::BUFF_DIM_X / 2];
using OType2x3D = fp4e2m1x2
    [tk_localcta::BUFFS_NUM_OUT]
    [tk_localcta::BUFF_OUT_DIM_Y]
    [tk_localcta::BUFF_OUT_DIM_X];
using OType2xt3D = fp4e2m1x2
    [tk_localcta::BUFFS_NUM_OUT_TR]
    [tk_localcta::BUFF_OUT_TR_DIM_Y]
    [tk_localcta::BUFF_OUT_TR_DIM_X];
using ScalesType2D = nvfp4_scale_t
    [tk_localcta::LocalCTAConfig::CHUNK_DIM_Y]
    [tk_localcta::SCALES_PER_CHUNK_X];
using ScalesTypeTr2D = nvfp4_scale_t
    [tk_localcta::LocalCTAConfig::CHUNK_DIM_X]
    [tk_localcta::SCALES_PER_CHUNK_Y];

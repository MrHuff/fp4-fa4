...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def(
        ...
        &project_dout_unified_fp4_nvfp4_v509_e5m2,
        "Fail-closed B1/S4096/H32/D128 v509 NVFP4 output-gradient "

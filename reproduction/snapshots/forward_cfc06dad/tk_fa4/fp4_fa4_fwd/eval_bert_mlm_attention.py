        ...
        def patched_forward(
            ...
            *,
            ...
            if (
                ...
                raise ValueError(
                    "the FP4 BERT adapter requires a full, unmasked block"
                )
...
def make_blocks(
    ...
    for index in range(samples):
        begin = index * 254
        content = token_ids[begin : begin + 254]
        blocks.append(
            torch.tensor(
...
def main() -> None:
    ...
    blocks = make_blocks(dataset, tokenizer, args.samples)

// PyTorch C++ wrapper for fused_te_quant_v4 kernel
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward_full", &fused_te_quant_v4_forward,
          "Fused RMSNorm+Act+NVFP4 V4 (TMA, PTX, encode/decode)");
}

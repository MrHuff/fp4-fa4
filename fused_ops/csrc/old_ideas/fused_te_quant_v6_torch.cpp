// PyTorch C++ wrapper for fused_te_quant_v6 (single-pass cooperative)
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward_full", &fused_te_quant_v6_forward,
          "Fused RMSNorm+Act+NVFP4 V6 (single-pass cooperative)");
}

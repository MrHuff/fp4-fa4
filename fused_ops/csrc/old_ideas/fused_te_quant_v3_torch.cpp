// PyTorch C++ wrapper for fused_te_quant_v3 kernel
...
// Declared in fused_te_quant_v3.cu
...
// Returns (fp4_data, scales, global_scale, inv_rms)
std::tuple<torch::Tensor, torch::Tensor, torch::Tensor, torch::Tensor> 
fused_te_quant_v3_forward(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("forward_full", &fused_te_quant_v3_forward,
          "Fused RMSNorm+Act+NVFP4 V3 (PTX, encode/decode scaling)");
}

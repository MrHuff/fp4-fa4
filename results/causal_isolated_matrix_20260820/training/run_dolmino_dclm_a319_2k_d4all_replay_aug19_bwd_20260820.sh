...
readonly RESULT_BASENAME="dolmino_dclm_a319_2k_d4all_replay_aug19_bwd_d2p0_nosplit_seed20260818_20260820"
...
readonly LAUNCHER_RELATIVE="results/causal_isolated_matrix_20260820/training/run_dolmino_dclm_a319_2k_d4all_replay_aug19_bwd_20260820.sh"
readonly PHYSICAL_GPU=3
readonly GPU_UUID="GPU-60db269d-3281-dae0-547b-e0d4ecd95e06"

# This uses the same fresh public DCLM prefix and model seed as the failed
# reconstructed runs, but restores the verified Aug19 backward extension and
# exact precomposed control. It retains D4ALL replay/scale handoff, native
# degree-2/period-0 EX2, represented MXFP4 V, and no gradient clipping.

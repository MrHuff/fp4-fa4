...
readonly MX_EXTENSION="/tmp/codex-causal-forward-matrix-d4q01-full-20260820/_C_cfwd_mx_d4q01_i1_s4096h32kv8d64_d4q01_full_20260820.cpython-312-aarch64-linux-gnu.so"
...
readonly RESULT_BASENAME="dolmino_dclm_a319_2k_d4q01_matched_aug19_bwd_d2p0_nosplit_seed20260818_20260820"
...
readonly LAUNCHER_RELATIVE="results/causal_isolated_matrix_20260820/training/run_dolmino_dclm_a319_2k_d4q01_matched_aug19_bwd_20260820.sh"
readonly PHYSICAL_GPU=3
readonly GPU_UUID="GPU-60db269d-3281-dae0-547b-e0d4ecd95e06"

# Fair performance rerun: use the fastest verified d4q01 MX forward and the
...
check_sha256 "ae648be9308a2ec74e9d6b70d3441d6af1d8452af85cad3b62150445785b9de9" \
    "${MX_EXTENSION}"
...
"${PYTHON_BIN}" -u -B \
    ...
    --mx-module _C_cfwd_mx_d4q01_i1_s4096h32kv8d64_d4q01_full_20260820 \
...
if ! jq -e \
    ...
    and .configuration.mx_forward_topology.mx_mode23_native_quarter_mask == 3
    and .configuration.mx_forward_topology.mx_mode23_native_stage_mask == 3
    and .configuration.mx_forward_extension.sha256
        == "ae648be9308a2ec74e9d6b70d3441d6af1d8452af85cad3b62150445785b9de9"

...
readonly MX_EXTENSION="/tmp/codex-causal-forward-matrix-d4all-focus-20260820/_C_cfwd_mx_d4all_i1_s4096h32kv8d64_d4all_focus_20260820.cpython-312-aarch64-linux-gnu.so"
readonly FP8_EXTENSION="/tmp/codex-causal-forward-matrix-d4all-focus-20260820/_C_cfwd_fp8exact0_for_d4all_s4096h32kv8d64_d4all_focus_20260820.cpython-312-aarch64-linux-gnu.so"
readonly RESULT_DIR="${RUN_ROOT}/results/causal_isolated_matrix_20260820/training"
readonly RESULT_BASENAME="dolmino_dclm_a319_2k_d4all_matched_aug19_bwd_d2p0_nosplit_seed20260818_20260820"
...
readonly LAUNCHER_RELATIVE="results/causal_isolated_matrix_20260820/training/run_dolmino_dclm_a319_2k_d4all_matched_aug19_bwd_20260820.sh"
readonly PHYSICAL_GPU=3
readonly GPU_UUID="GPU-60db269d-3281-dae0-547b-e0d4ecd95e06"

# Fair performance rerun: use the stable verified d4all MX forward and the
# same retained-E4M3 d2/p0 backward specialization for both low-precision
# routes. MX-only probability replay and scale handoff are explicitly disabled.
# The verified Aug19 backward extension/control and no-clipping policy remain.
...
check_sha256 "dceb7a5a981af105215541b3c7c220ffba64e3a32d0ec27f66007fe218218eaf" \
    "${MX_EXTENSION}"
check_sha256 "3d440fad1a04e0dc04f687e563f79e5dcb487e0173cb563cedc6302fcfedd314" \
    "${FP8_EXTENSION}"
...
"${PYTHON_BIN}" -u -B \
    ...
    --mx-module _C_cfwd_mx_d4all_i1_s4096h32kv8d64_d4all_focus_20260820 \
    --fp8-extension "${FP8_EXTENSION}" \
    --fp8-module _C_cfwd_fp8exact0_for_d4all_s4096h32kv8d64_d4all_focus_20260820 \
    --backward-gain 1.0 \
    --q-quant-scale 2.25 \
    --k-quant-scale 2.0 \
...
if ! jq -e \
    ...
    and .configuration.backward_exp2_route_policies["nvfp4_qk_mxfp4_pv"]
        == .configuration.backward_exp2_route_policies["nvfp4_qk_fp8_pv_exact"]
    and .configuration.backward_probability_tmem_route_policies["nvfp4_qk_mxfp4_pv"]
        == .configuration.backward_probability_tmem_route_policies["nvfp4_qk_fp8_pv_exact"]
    and .configuration.backward_raster_route_policies["nvfp4_qk_mxfp4_pv"]
        == .configuration.backward_raster_route_policies["nvfp4_qk_fp8_pv_exact"]
    and .configuration.backward_detached_fp8_p_tmem_routes["nvfp4_qk_mxfp4_pv"]
        == .configuration.backward_detached_fp8_p_tmem_routes["nvfp4_qk_fp8_pv_exact"]
    and .configuration.backward_head_fast_rasters["nvfp4_qk_mxfp4_pv"]
        == .configuration.backward_head_fast_rasters["nvfp4_qk_fp8_pv_exact"]
    ...
    and .configuration.mx_forward_extension.sha256
        == "dceb7a5a981af105215541b3c7c220ffba64e3a32d0ec27f66007fe218218eaf"
    and .configuration.fp8_forward_extension.sha256
        == "3d440fad1a04e0dc04f687e563f79e5dcb487e0173cb563cedc6302fcfedd314"

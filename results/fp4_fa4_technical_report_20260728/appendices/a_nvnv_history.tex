...
\midrule
\input{../fp4_fa4_b300_tuning_20260802/tables/b300_d64_rows.tex}%
\end{tabular}
\end{adjustbox}
\end{table}
...
to the row anchor; HAO remains finite on every full replay.
...
\midrule
\input{../fp4_fa4_unified_20260801/tables/downstream_nvnv_failure_rows.tex}%
\end{tabular}
\end{adjustbox}
\end{table}

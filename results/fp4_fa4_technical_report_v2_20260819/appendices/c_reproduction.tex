...
The public code release is available at \projectrepo. It contains the TK
forward and backward kernels, the CuTe-DSL comparison and prototype kernels,
experiment configurations, committed evidence, and the scripts used to build
this paper.

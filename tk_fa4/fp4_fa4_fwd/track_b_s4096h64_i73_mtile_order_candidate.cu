// Candidate-only I73 S4096/H64 CTA-order discriminator.  It deliberately
// excludes generic dispatch and pybind catalogs so only the two exact route
// specializations can become entry functions.
#define TK_FA4_FORWARD_ONLY_BUILD 1
#define TK_FA4_SUPPRESS_B300_CAUSAL_DISPATCH 1
#define TK_FA4_TRACK_B_S4096H64_I73_M_TILE_ORDER_ONLY_BUILD 1
...
using track_b_s4096h64_i73_base =
    config_fp4pv_stage2_ex2_alu_pchain_c_head_interleaved_lazy_output_rescale<
        16, 128, 128, 192, 128, 200, 56, 112, 1>;

struct config_fp4pv_track_b_s4096h64_i73_mtile_ascending
    : public track_b_s4096h64_i73_base {
    static constexpr int TRACK_B_S4096H64_M_TILE_ORDER = 1;
};

struct config_fp4pv_track_b_s4096h64_i73_mtile_descending_control
    : public track_b_s4096h64_i73_base {
    static constexpr int TRACK_B_S4096H64_M_TILE_ORDER = -1;
};
...
#include "track_b_s4096h64_i73_mtile_order_minimal_host.inc"

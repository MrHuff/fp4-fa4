...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v436 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v436 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v436_d128_gqa_e4m3_exact_s4096_runtime_accumulate_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "head_fast_grid_x_key_tile_grid_y_exact_s4096_runtime_fp8_accum";
    ...
    result["exact_sequence_specialization"] = 4096;
    result["non_exact_sequence_fallback"] = "v433_head_fast_raster";
    result["gradient_accumulate_control"] =
        "runtime_predicate_on_first_cta_group1_f8f6f4_mma";

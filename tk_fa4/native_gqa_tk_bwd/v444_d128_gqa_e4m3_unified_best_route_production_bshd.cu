#include "v444_d128_gqa_e4m3_unified_best_route_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v444_d128_gqa_e4m3_unified_best_route_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v444 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v444 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v444_d128_gqa_e4m3_unified_best_route_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "thin_frozen_dispatch_B1_S4096_v439_owner2_exact_"
        "B2_S4096_v443_owner4_compact_probability_direct_dkdv_"
    ...
    result["backward_out_physical_clear_policy"] =
        "B2_S4096_memset_dq_only_direct_overwrite_dkdv;"
        "B1_S4096_and_all_nonexact_routes_memset_dq_dk_dv";
    result["dispatch"] =
        "B1_S4096_v439;B2_S4096_v443;B1_other_v436;B2_other_v437";
    result["selected_exact_kernels"] = pybind11::make_tuple(
        "v439::b1_owner2_exact_s4096_kernel",
        "v443::owner4_kernel"
    );
    ...
    // The public ABI remains an additive BF16 gradient boundary.  The exact
    // B2 route is free to realize the semantic reset with a complete
    // unique-writer overwrite, which is described separately below.
    ...
    result["b1_s4096_route"] =
        "v439_owner2_exact_additive_dq_dk_dv";
    result["b2_s4096_route"] =
        "v443_owner4_compact_p_additive_dq_unique_direct_dkdv";

...
#include "v469_d128_gqa_e4m3_b2_s4096_owner4_dk_commit_gated_ds_reuse_production_bshd.cuh"

// Thin dispatcher derived only from frozen v467.  Exact B1/S4096 still
// launches v445's owner-2 compact-P kernel.  Exact B2/S4096 now delegates to
// v469's owner-4 compact-P/quarter-dP/split-dV/direct-dK-dV kernel, retaining
// both later-dK-commit-gated operand-stage reuse and later-dK-commit-gated
// shared-dS reuse.  Non-exact B1 and B2 still select frozen v436 and v437,
// respectively, through v469.  This router adds no device implementation and
// changes neither numerical operations nor launch geometry in any route.
namespace tkfa4::native_gqa_tk_bwd::v470_d128_gqa_e4m3_unified_best_route_production_bshd {
...
namespace b2_exact_and_fallbacks =
    tkfa4::native_gqa_tk_bwd::v469_d128_gqa_e4m3_b2_s4096_owner4_dk_commit_gated_ds_reuse_production_bshd;
...
inline void launch(
    ...
    // v469 selects exact B2's quarter-dP/split-dV owner-4 kernel with both
    // later-dK-gated reuse properties, frozen v436 for non-exact B1, and
    // frozen v437 for non-exact B2.

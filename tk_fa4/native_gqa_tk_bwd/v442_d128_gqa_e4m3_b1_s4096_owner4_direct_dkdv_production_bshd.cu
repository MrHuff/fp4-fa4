...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v442 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v442 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v442_d128_gqa_e4m3_b1_s4096_owner4_direct_dkdv_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "b1_s4096_owner4_exact_runtime_direct_dkdv_"
        "all_other_shapes_v441";
    ...
    result["batch_dispatch"] =
        "B1_S4096_owner4_direct_all_other_shapes_v441";

#include "v473_d128_gqa_e4m3_unified_best_route_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v473_d128_gqa_e4m3_unified_best_route_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v473 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v473 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v473_d128_gqa_e4m3_unified_best_route_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "thin_frozen_dispatch_B1_S4096_v445_owner2_compact_probability_"
        "B2_S4096_v472_owner4_compact_probability_first_half_quarter_dp_"
    ...
    result["b2_s4096_route"] =
        "v472_owner4_compact_p_first_half_quarter_dp_"
        "fence_before_thread_sync_split_dv_dv_ready_gated_probability_"
        "operand_consumed_gated_stats_later_dk_commit_gated_operand_stage_"
        "reuse_later_dk_commit_gated_shared_ds_reuse_head_boundary_score_"
        "before_dq_drain_additive_dq_unique_"
        "direct_dkdv";
    ...
    result["b2_s4096_head_boundary_dp_reuse_gate"] =
        "previous_dq_drained_before_aliased_dp_issue";

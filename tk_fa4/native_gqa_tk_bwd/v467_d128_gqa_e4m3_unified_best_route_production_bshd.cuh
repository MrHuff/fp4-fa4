...
#include "v466_d128_gqa_e4m3_b2_s4096_owner4_operand_gated_stats_reuse_production_bshd.cuh"
...
// non-exact fallback are delegated to v466, which selects its owner-4
// compact-P/quarter-dP/split-dV/direct-dK-dV kernel with dv-ready-gated
// shared-P reuse and operand-consumed-gated stats reuse for exact B2, frozen
// v436 for non-exact B1, and frozen v437 for non-exact B2.  This router adds
// no device implementation and changes neither numerical operations nor
// launch geometry in any selected route.
namespace tkfa4::native_gqa_tk_bwd::v467_d128_gqa_e4m3_unified_best_route_production_bshd {
...
namespace b2_exact_and_fallbacks =
    tkfa4::native_gqa_tk_bwd::v466_d128_gqa_e4m3_b2_s4096_owner4_operand_gated_stats_reuse_production_bshd;
...
inline void launch(
    ...
    // v466 selects exact B2's barrier-trimmed quarter-dP/split-dV owner-4

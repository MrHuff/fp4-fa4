...
#include "v472_d128_gqa_e4m3_b2_s4096_owner4_head_score_before_dq_drain_production_bshd.cuh"

// Thin dispatcher derived only from frozen v470.  Exact B1/S4096 still
// launches v445's owner-2 compact-P kernel.  Exact B2/S4096 now delegates to
// v472's owner-4 compact-P/quarter-dP/split-dV/direct-dK-dV kernel, retaining
// both later-dK-commit-gated reuse properties and issuing next-head score
// before the previous dQ drain.  Non-exact B1 and B2 still select frozen v436
// and v437, respectively, through v472.  This router adds no device
// implementation and changes neither numerical operations nor launch geometry.
namespace tkfa4::native_gqa_tk_bwd::v473_d128_gqa_e4m3_unified_best_route_production_bshd {
...
namespace b2_exact_and_fallbacks =
    tkfa4::native_gqa_tk_bwd::v472_d128_gqa_e4m3_b2_s4096_owner4_head_score_before_dq_drain_production_bshd;
...
inline void launch(
    ...
    // v472 selects exact B2's quarter-dP/split-dV owner-4 kernel with both
    // later-dK-gated reuse properties and the head-boundary score overlap,
    // frozen v436 for non-exact B1, and frozen v437 for non-exact B2.

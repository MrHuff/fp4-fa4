...
// B2/S4096 split-dV scheduling experiment derived byte-for-source from frozen
// v447.  Preserve its owner-4/direct-dK-dV topology, compact exact-rounded
// E4M3 P reuse, and half-0 dP preissue.  Publish each shared P half separately:
// dV K32 chunks 0-1 issue after P0 while compute produces P1, then chunks 2-3
// issue after P1 and alone commit dv_ready.  P1 still loads before dS0, so the
// v424 early score-TMEM release remains intact.  B1 falls back to v436; other
// B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v455_d128_gqa_e4m3_b2_s4096_owner4_split_dv_compact_p_reuse_production_bshd {

#include "v501_d128_gqa_e4m3_unified_best_route_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v501_d128_gqa_e4m3_unified_best_route_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v501 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v501 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["topology"] =
        "thin_frozen_dispatch_B1_S4096_v488_owner2_compact_probability_"
        "split_dq_tmem_release_B2_S4096_v490_owner4_compact_probability_"
        "first_half_quarter_dp_"
        ...
        "reuse_later_dk_commit_gated_shared_ds_reuse_head_boundary_score_"
        "before_dq_drain_deferred_packed_d0_d1_register_payload_"
        "paired_final_x32_loads_dq_tmem_release_before_all_four_chunk_"
        "shared_stores_dedicated_warp14_gradient_publisher_direct_dkdv_"
    ...
    result["b2_s4096_route"] =
        "v490_owner4_compact_p_first_half_quarter_dp_"
        "fence_before_thread_sync_split_dv_dv_ready_gated_probability_"
        "operand_consumed_gated_stats_later_dk_commit_gated_operand_stage_"
        "reuse_later_dk_commit_gated_shared_ds_reuse_head_boundary_score_"
        "before_dq_drain_deferred_packed_d0_d1_register_payload_"
        "paired_final_x32_loads_dq_tmem_release_before_all_d0_d3_shared_"
        "stores_dedicated_warp14_gradient_publisher_additive_dq_unique_"
        "direct_dkdv";
    ...
    result["b1_s4096_dq_tmem_release_point"] =
        "after_complete_exact_bf16_register_capture_before_shared_store";
    result["b1_s4096_dq_shared_publication_ready_barrier"] =
        "dq_drained";
    ...
    result["b2_s4096_dq_tmem_release_point"] =
        "after_d0_d1_bf16_pack_and_paired_final_x32_tmem_loads_"
        "complete_before_d0_d1_d2_d3_shared_stores";
    result["b2_s4096_dq_tmem_release_control_flow"] =
        "deferred_packed_d0_d1_plus_paired_final_two_depth_chunks";
    result["b2_s4096_dq_deferred_packed_chunks"] =
        pybind11::make_tuple(0, 1);
    result["b2_s4096_dq_deferred_packed_words_per_lane"] =
        candidate::b2_exact_and_fallbacks::prior::kDepthChunk;
    result["b2_s4096_dq_shared_publication_ready_barrier"] =
        "dq_drained";
    result["b2_s4096_gradient_publication_warp"] =
        candidate::b2_exact_and_fallbacks::kGradientPublisherWarp;
    result["b2_s4096_gradient_publication_stages"] = 1;
    result["b2_s4096_gradient_publication_reuse"] =
        "dedicated_warp14_single_issuer_read_wait_zero_then_signal";

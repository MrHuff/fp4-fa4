#include "v430_d128_gqa_e4m3_register_dq_evacuation_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v430_d128_gqa_e4m3_register_dq_evacuation_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v430 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v430 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v430_d128_gqa_e4m3_register_dq_evacuation_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "mbarrier_full_dq_register_evacuation_bf16_d32x2_publication";
    ...
    result["dp_dq_alias_gate"] =
        "four_warp_collective_after_all_four_dq_x32_loads_reach_registers";
    ...
    result["gradient_drain"] =
        "dq_full_register_evacuation_then_bf16_d32_publication_"
        "dk_dv_owner_x32_serial_bf16_d32_publication";
    result["gradient_tmem_load_opcode"] =
        "tcgen05.ld.sync.aligned.32x32b.x32.b32";
    result["gradient_tmem_load_wait"] =
        "d0_immediate_wait_before_pack_d1_d2_d3_batched_then_wait";
    result["dq_register_payload_u32_per_lane"] = 112;
    result["compute_role_register_limit"] = 128;
    result["reducer_role_register_limit"] = 152;
    result["control_role_register_limit"] = 96;
    result["gradient_intermediate_shared_dtype"] = "none";

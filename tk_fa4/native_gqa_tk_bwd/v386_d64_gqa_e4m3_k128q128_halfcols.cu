...
void check_bhsd(
    ...
    TORCH_CHECK(
        tensor.scalar_type() == dtype && tensor.dim() == 4 &&
            ...
            tensor.size(2) % 128 == 0 && tensor.size(3) == candidate::kDepth,
        name,
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v386 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v386 D64 GQA K128xQ128 backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v386_d64_gqa_e4m3_k128q128_halfcols_v1";
    result["topology"] =
        "single_cta_k128_q128_role_specialized_reused_q64_fragment";

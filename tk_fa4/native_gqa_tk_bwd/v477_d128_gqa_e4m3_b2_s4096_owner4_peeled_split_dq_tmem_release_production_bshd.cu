#include "v477_d128_gqa_e4m3_b2_s4096_owner4_peeled_split_dq_tmem_release_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v477_d128_gqa_e4m3_b2_s4096_owner4_peeled_split_dq_tmem_release_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v477 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v477 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v477_d128_gqa_e4m3_b2_s4096_owner4_peeled_split_dq_tmem_release_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "final_x32_load_split_dq_tmem_release_before_final_bf16_pack_"
        "peeled_final_dq_depth_chunk_straight_line_tmem_release_"
    ...
    result["dq_tmem_release_point"] =
        "after_final_x32_tmem_load_completion_before_final_chunk_bf16_"
        "pack_and_shared_stores";

...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v438 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v438 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v438_d128_gqa_e4m3_b2_owner2_exact_s4096_production_bshd_v1";
    ...
    result["non_specialized_fallback"] =
        "v436_exact_s4096_runtime_accumulate";
    ...
    result["batch_dispatch"] =
        "B2_S4096_owner2_exact_B1_or_non_S4096_v436";

...
// B1/S4096 sequential owner-2 experiment reusing v438's retained K/V,
// FP32 dK/dV ownership, exact sequence schedule, and runtime first E4M3
// gradient-MMA accumulate predicate.  All other shapes fall back to v438.
namespace tkfa4::native_gqa_tk_bwd::v439_d128_gqa_e4m3_b1_owner2_exact_s4096_production_bshd {
...
void b1_owner2_exact_s4096_kernel(const __grid_constant__ globals g) {
...
inline void launch(
    ...
    b1_owner2_exact_s4096_kernel<<<grid, kThreads, 0, stream>>>(g);

#include "v425_d128_gqa_e4m3_d1p2_async_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v425_d128_gqa_e4m3_d1p2_async_production_bshd;
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v425_d128_gqa_e4m3_d1p2_async_production_bshd_v1";
    ...
    result["probability_exp"] =
        "native_degree1_period2_packed_f32x2_production_clamp8";
    result["probability_native_pairs_per_half"] = 8;
    result["probability_degree1_pairs_per_half"] = 8;
    result["probability_degree1_packed_fma_per_pair"] = 1;
    result["probability_word_schedule"] =
        "native_first_adjacent_degree1_two_words_then_e4m3_v2_store";

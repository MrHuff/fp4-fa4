...
// B2/S4096 compact-probability experiment derived from frozen v441.  Keep
// v441's owner-4/direct-dK-dV schedule, but retain the exact rounded E4M3 P
// words in registers through dP and reuse them for dS.  The same words remain
// published to the coordinate-correct shared P tile for dV.  B1 falls back to
// v436; other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v443_d128_gqa_e4m3_b2_s4096_owner4_compact_p_reuse_production_bshd {

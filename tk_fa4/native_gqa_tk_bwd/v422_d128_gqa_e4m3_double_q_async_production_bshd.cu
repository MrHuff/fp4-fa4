...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v422 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v422 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v422_d128_gqa_e4m3_double_q_async_production_bshd_v1";

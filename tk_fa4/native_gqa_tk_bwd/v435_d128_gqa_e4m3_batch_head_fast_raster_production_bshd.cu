#include "v435_d128_gqa_e4m3_batch_head_fast_raster_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v435_d128_gqa_e4m3_batch_head_fast_raster_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v435 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v435 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v435_d128_gqa_e4m3_batch_head_fast_raster_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "batch_head_fast_grid_x_key_tile_grid_y_grid_z_one";

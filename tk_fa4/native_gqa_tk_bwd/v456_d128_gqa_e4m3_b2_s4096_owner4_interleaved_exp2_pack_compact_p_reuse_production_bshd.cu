#include "v456_d128_gqa_e4m3_b2_s4096_owner4_interleaved_exp2_pack_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v456_d128_gqa_e4m3_b2_s4096_owner4_interleaved_exp2_pack_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v456 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v456 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v456_d128_gqa_e4m3_b2_s4096_owner4_interleaved_exp2_pack_compact_p_reuse_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "exp2_pack_publication_b1_v436_other_b2_v437";
    ...
    result["probability_numerics_parent"] =
        "v447_exact_native_exp2_clamp_and_e4m3_rounding";

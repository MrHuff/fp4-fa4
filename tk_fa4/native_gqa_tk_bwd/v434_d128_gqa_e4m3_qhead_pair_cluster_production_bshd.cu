#include "v434_d128_gqa_e4m3_qhead_pair_cluster_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v434_d128_gqa_e4m3_qhead_pair_cluster_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v434 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v434 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v434_d128_gqa_e4m3_qhead_pair_cluster_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "cluster2_adjacent_qheads_private_qdo_stats_dq_multicast_kv_"
        "bf16_dsm_dkdv_rank0_full_width_tma";
    ...
    result["output_encoding_scale"] = 4.0;
    result["cluster_shape"] = "2x1x1";
    result["cluster_grid"] = "Hq,S/128,B";
    result["kv_load_policy"] = "rank0_multicast_to_pair";
    result["dq_policy"] = "private_v432_full_width_additive_tma";
    result["dkdv_policy"] =
        "independent_bf16_round_dsm_pair_sum_rank0_additive_tma";

...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v482 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v482 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v482_d128_gqa_e4m3_b2_s4096_owner4_deferred_packed_d0_d1_dq_release_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "deferred_packed_d0_d1_register_payload_"
        "paired_final_x32_loads_one_wait_split_dq_tmem_release_"
        "before_all_four_chunk_shared_stores_"
    ...
    result["dq_deferred_packed_chunks"] =

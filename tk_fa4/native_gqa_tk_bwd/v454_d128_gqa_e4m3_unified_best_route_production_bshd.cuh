...
#include "v447_d128_gqa_e4m3_b2_s4096_owner4_dp_half0_preissue_compact_p_reuse_production_bshd.cuh"
...
// non-exact fallback are delegated to v447, which selects its owner-4
// compact-P/half0-dP-preissue/direct-dK-dV kernel for exact B2, frozen v436
// for non-exact B1, and frozen v437 for non-exact B2.  This router adds no
// device implementation and changes neither numerical operations nor launch
// geometry in any selected route.
namespace tkfa4::native_gqa_tk_bwd::v454_d128_gqa_e4m3_unified_best_route_production_bshd {
...
namespace b2_exact_and_fallbacks =
    tkfa4::native_gqa_tk_bwd::v447_d128_gqa_e4m3_b2_s4096_owner4_dp_half0_preissue_compact_p_reuse_production_bshd;
...
inline void launch(
    ...
    // v447 selects exact B2's accepted owner-4/direct-dK-dV kernel, frozen

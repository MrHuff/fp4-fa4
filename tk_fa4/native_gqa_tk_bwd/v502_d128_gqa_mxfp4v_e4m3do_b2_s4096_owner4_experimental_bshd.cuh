...
// Experimental B2/S4096-only MXFP4-V x E4M3-dO dP fork of v490.
// Preserve v490's owner-4/direct-dK-dV topology and gradient publication.
// Only dP changes: a row-major packed MXFP4 V payload is manually restaged to
// SM100's aligned E2M1 shared representation and multiplied by resident E4M3
// dO with mxf8f6f4.  This file is deliberately fail-closed to B2/S4096.
namespace tkfa4::native_gqa_tk_bwd::v502_d128_gqa_mxfp4v_e4m3do_b2_s4096_owner4_experimental_bshd {
        ...
        for (int local_head = 0; local_head < kHeadsPerOwner; ++local_head) {
            ...
            for (
                ...
                if (has_next) {
                    ...
                    // dP completion proves the aliased scale pages are dead.
                    // Produce and drain the next score before restaging them.
                    wait(dp_ready, phase);
                    wait(
...
inline void launch(
    ...
    TORCH_CHECK(
        ...
        "v502 experimental MXFP4-V backward is fail-closed to B2/S4096"
    );

...
// Role-specialized K128 x Q128 backward pipeline.  Unlike v386, score has two
// private TMEM stages and no longer aliases dP/dQ.  Q/dO, statistics, and the
// shared P/dS operand are double buffered.  The steady-state role loops use
// phase-counted mbarriers; CTA-wide synchronization is confined to prologue.
namespace tkfa4::native_gqa_tk_bwd::v387_d64_gqa_e4m3_async_pipeline {
...
inline void launch(
    ...
    v387_d64_gqa_e4m3_async_pipeline::main_kernel<<<
        grid,
        kThreads,
        0,
        stream

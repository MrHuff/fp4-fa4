...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v421 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v421 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v421_d128_gqa_e4m3_async_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "split_qhead_cta_k128_q128_single_score_shared_p_shared_ds_"
        "role_specialized_mbarrier_two_stage_d32_publication";
    ...
    result["query_smem_stages"] = 1;
    result["query_stage_reason"] =
        "bounded_single_stage_control_for_v422_double_buffer_ablation";
    ...
    result["shared_reuse_gates"] =
        "P_dV_plus_compute_dS_dS_dQ_plus_dK_Q_dK_dO_dP_plus_dV";
    result["tmem_map"] =

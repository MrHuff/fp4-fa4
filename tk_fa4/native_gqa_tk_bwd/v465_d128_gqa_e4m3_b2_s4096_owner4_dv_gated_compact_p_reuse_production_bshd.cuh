...
// B2/S4096 synchronization-elision experiment derived only from frozen v460.
...
// and all numerical operations.  Compact-P dS consumes per-warp registers, so
// dv_ready completion after dV half 1 is the sole shared-P reuse gate; the
// older aggregate P-consumed barrier is redundant.  B1 falls back to v436;
// other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v465_d128_gqa_e4m3_b2_s4096_owner4_dv_gated_compact_p_reuse_production_bshd {

...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v432 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v432 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v432_d128_gqa_e4m3_full_gradient_tma_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "owner_x32_single_full_bf16_gradient_tile_three_full_width_tma";

...
// dQ/dK waits, wait for it, issue x16 chunk 1, then use a tensor-proxy compiler
// fence immediately followed by warp synchronization before chunk-0 arithmetic.
// B1 falls back to v436; other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v462_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd {

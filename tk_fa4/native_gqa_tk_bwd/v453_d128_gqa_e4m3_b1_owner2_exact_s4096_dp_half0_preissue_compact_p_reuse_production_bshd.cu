#include "v453_d128_gqa_e4m3_b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v453_d128_gqa_e4m3_b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v453 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v453 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v453_d128_gqa_e4m3_b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_production_bshd_v1";

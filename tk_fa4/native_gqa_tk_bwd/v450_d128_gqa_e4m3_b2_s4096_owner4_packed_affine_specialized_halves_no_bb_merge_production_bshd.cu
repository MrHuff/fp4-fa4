#include "v450_d128_gqa_e4m3_b2_s4096_owner4_packed_affine_specialized_halves_no_bb_merge_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v450_d128_gqa_e4m3_b2_s4096_owner4_packed_affine_specialized_halves_no_bb_merge_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v450 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v450 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v450_d128_gqa_e4m3_b2_s4096_owner4_packed_affine_specialized_halves_no_bb_merge_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "packed_fp32x2_score_lstat_affine_compact_rounded_e4m3_p_"
        "compile_time_column_half_specialization_register_reuse_"
    ...
    result["probability_affine"] =
        "packed_fp32x2_score_times_beta_log2e_plus_additive_lstat";
    result["probability_affine_donor"] =
        "authenticated_bf16_commit_6c317a3b";
    result["probability_half_dispatch"] =
        "compile_time_specializations_ColumnHalf_0_and_1";
    result["ptxas_basic_block_merge"] = "disabled_for_v450_artifact";
    result["probability_operation_order"] =
        "affine_then_diagonal_mask_then_clamp_exp2_then_e4m3_round";
    result["probability_numerical_abi"] =
        "unchanged_beta_log2e_additive_lstat_and_rounded_e4m3_payload";

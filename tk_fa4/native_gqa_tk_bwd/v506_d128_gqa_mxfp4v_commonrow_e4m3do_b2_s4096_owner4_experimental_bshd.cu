#include "v506_d128_gqa_mxfp4v_commonrow_e4m3do_b2_s4096_owner4_experimental_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v506_d128_gqa_mxfp4v_commonrow_e4m3do_b2_s4096_owner4_experimental_bshd;
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v506 experimental MXFP4-V backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v506_d128_gqa_mxfp4v_commonrow_e4m3do_b2_s4096_owner4_"
        "experimental_bshd_v2_direct_bf16_amax_common_anchor";
    result["source_file"] = __FILE__;
    result["experimental"] = true;
    result["production_data_abi_compatible"] = false;
    result["required_data_abi"] =
        "experimental_commonrow_mxfp4_v2_direct_bf16_amax_"
        "not_current_per_D32_producer";
    ...
    result["v_shared_restage"] =
        "direct_commonrow_packed_to_align16b_8_payload_bytes_then_8_gap";
    result["v_row_scale_reduction"] =
        "producer_owned_direct_D128_BF16_amax_to_one_e8m0_"
        "repeated_four_slots";
    result["v_row_requantization"] =
        "none;_producer_direct_BF16_to_E2M1_RNE_under_common_anchor";
    result["producer_bf16_row_passes"] = 2;
    result["producer_bf16_row_pass_contract"] =
        "first_D128_amax_then_second_direct_E2M1_quantization;_"
        "unavoidable_without_buffering_or_forward_ABI_change";
    result["producer_uses_intermediate_D32_codes"] = false;
    result["producer_uses_requantization_lut"] = false;
    result["producer_reuses_forward_quantization"] = false;
    result["producer_normalized_commonrow_abi"] = true;
    result["consumer_reads_scale_slot"] = 0;
    result["consumer_validates_repeated_scale_slots"] = false;
    result["v_zero_scale_contract"] =
        "producer_common_code0_iff_D128_BF16_amax_exponent_zero;_"
        "payload_direct_quantized;_consumer_factor0_exact";
    result["dp_opcode"] =
    ...
    result["startup_barrier_policy"] =
        "semaphore_init_barrier_then_direct_restage_then_CTA_visibility_barrier";
    result["shared_memory_receipt"] =
        "candidate_payload_166400B_plus_existing_v490_semaphores;_"
        "verify_actual_ptxas_at_build";
    result["resource_receipt_scope"] =
        "experimental_candidate_verify_at_build";
    return result;
}

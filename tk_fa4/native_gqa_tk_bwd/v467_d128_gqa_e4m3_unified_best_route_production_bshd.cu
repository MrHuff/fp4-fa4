#include "v467_d128_gqa_e4m3_unified_best_route_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v467_d128_gqa_e4m3_unified_best_route_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v467 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v467 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v467_d128_gqa_e4m3_unified_best_route_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "thin_frozen_dispatch_B1_S4096_v445_owner2_compact_probability_"
        "B2_S4096_v466_owner4_compact_probability_first_half_quarter_dp_"
        "fence_before_thread_sync_split_dv_dv_ready_gated_probability_"
        "operand_consumed_gated_stats_direct_dkdv_"
    ...
    result["b2_s4096_route"] =
        "v466_owner4_compact_p_first_half_quarter_dp_"
        "fence_before_thread_sync_split_dv_dv_ready_gated_probability_"
        "operand_consumed_gated_stats_additive_dq_unique_direct_dkdv";
    ...
    result["b2_s4096_stats_shared_reuse_gate"] =
        "per_stage_operand_consumed_after_aggregate_ds_ready_and_dk_dv_"
        "completion";

...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v423 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v423 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v423_d128_gqa_e4m3_d2p2_async_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "split_qhead_cta_k128_q128_single_score_double_qdo_stats_"
        "shared_p_shared_ds_role_mbarrier_d32x2_publication";
    ...
    result["input_reuse_gate"] =
        "stage_specific_after_score_dk_dp_dv_readers";

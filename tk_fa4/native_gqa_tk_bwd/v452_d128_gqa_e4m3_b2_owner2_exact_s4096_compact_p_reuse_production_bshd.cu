#include "v452_d128_gqa_e4m3_b2_owner2_exact_s4096_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v452_d128_gqa_e4m3_b2_owner2_exact_s4096_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v452 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v452 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v452_d128_gqa_e4m3_b2_owner2_exact_s4096_compact_p_reuse_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "b2_s4096_flat_batch_head_pair_fast_owner2_exact_schedule_"
        "retained_kv_fp32_dkdv_private_dq_runtime_first_accumulate_"
        "compact_rounded_e4m3_p_register_reuse_"
        "all_other_shapes_v437_fallback";
    ...
    result["non_specialized_fallback"] =
        "v437_b2_owner2_dynamic_sequence_with_v433_b1_fallback";
    ...
    result["batch_dispatch"] =
        "B2_S4096_owner2_exact_all_other_shapes_v437";

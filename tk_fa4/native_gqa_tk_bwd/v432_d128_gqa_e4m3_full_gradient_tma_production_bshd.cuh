...
// D128 exact-native production-backward experiment derived from v431.  It
// keeps v431's compute, native-EX2 numerics, score release, and early full-dQ
...
namespace tkfa4::native_gqa_tk_bwd::v432_d128_gqa_e4m3_full_gradient_tma_production_bshd {
...
inline void launch(
    ...
    v432_d128_gqa_e4m3_full_gradient_tma_production_bshd::main_kernel<<<
        grid,
        kThreads,
        0,
        stream

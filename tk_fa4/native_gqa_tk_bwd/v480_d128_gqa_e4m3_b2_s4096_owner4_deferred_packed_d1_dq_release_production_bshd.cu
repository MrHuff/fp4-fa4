#include "v480_d128_gqa_e4m3_b2_s4096_owner4_deferred_packed_d1_dq_release_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v480_d128_gqa_e4m3_b2_s4096_owner4_deferred_packed_d1_dq_release_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v480 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v480 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v480_d128_gqa_e4m3_b2_s4096_owner4_deferred_packed_d1_dq_release_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "deferred_packed_d1_register_payload_"
        "paired_final_x32_loads_one_wait_split_dq_tmem_release_"
        "before_final_three_chunk_shared_stores_"
    ...
    result["dq_tmem_release_point"] =
        "after_d1_bf16_pack_and_paired_final_x32_tmem_loads_complete_"
        "before_d1_d2_d3_shared_stores";
    result["dq_tmem_release_control_flow"] =
        "deferred_packed_d1_plus_paired_final_two_depth_chunks";
    result["dq_deferred_packed_chunk"] = 1;
    result["dq_deferred_packed_words_per_lane"] =
        candidate::prior::kDepthChunk / 2;

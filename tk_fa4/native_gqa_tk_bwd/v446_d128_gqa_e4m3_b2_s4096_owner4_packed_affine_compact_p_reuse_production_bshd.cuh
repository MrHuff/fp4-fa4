...
// Isolated B2/S4096 packed-affine experiment derived from frozen v443.  Keep
// v443's owner-4/direct-dK-dV schedule and exact rounded-E4M3 compact-P reuse,
// but express score * beta_log2e + lstat as adjacent packed FP32x2 operations.
// This mirrors the authenticated BF16 donor at commit 6c317a3b while retaining
// this kernel's additive lstat ABI.  B1 falls back to v436; other B2 sequence
// lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v446_d128_gqa_e4m3_b2_s4096_owner4_packed_affine_compact_p_reuse_production_bshd {

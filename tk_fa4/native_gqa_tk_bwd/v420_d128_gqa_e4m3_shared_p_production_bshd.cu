...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v420 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v420 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["gradient_epilogue_scale"] =
        candidate::kGradientOutputScale;

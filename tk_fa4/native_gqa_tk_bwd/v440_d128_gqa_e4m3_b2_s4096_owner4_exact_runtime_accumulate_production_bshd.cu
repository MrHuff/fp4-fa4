#include "v440_d128_gqa_e4m3_b2_s4096_owner4_exact_runtime_accumulate_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v440_d128_gqa_e4m3_b2_s4096_owner4_exact_runtime_accumulate_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v440 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v440 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v440_d128_gqa_e4m3_b2_s4096_owner4_exact_runtime_accumulate_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "b2_s4096_flat_batch_kv_owner_fast_owner4_exact_runtime_"
        "retained_kv_fp32_dkdv_private_dq_b1_v436_other_b2_v437";
    ...
    result["owner4_dq_policy"] = "private_per_head_full_width_tma";
    result["owner4_dkdv_policy"] =
        "fp32_tmem_accumulate_four_heads_then_owner_additive_tma";

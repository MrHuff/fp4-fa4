...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v429 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v429 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v429_d128_gqa_e4m3_owner_x32_gradient_publication_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "mbarrier_owner_x32_direct_bf16_d32x2_publication";
    ...
    result["gradient_drain"] =
        "four_owner_warps_x32_immediate_bf16_direct_d32_publication";

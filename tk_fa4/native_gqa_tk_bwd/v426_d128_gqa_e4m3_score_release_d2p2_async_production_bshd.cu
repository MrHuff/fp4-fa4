#include "v426_d128_gqa_e4m3_score_release_d2p2_async_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v426_d128_gqa_e4m3_score_release_d2p2_async_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v426 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v426 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v426_d128_gqa_e4m3_score_release_d2p2_async_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "split_qhead_cta_k128_q128_single_score_double_qdo_stats_"
        "early_score_release_early_dp_next_native_d2p2_shared_p_shared_ds_role_"
        "mbarrier_d32x2_publication";
    ...
    result["probability_exp"] =
        "native_degree2_period2_packed_f32x2_production_clamp8";
    result["probability_native_pairs_per_half"] = 8;
    result["probability_degree2_pairs_per_half"] = 8;
    result["probability_degree2_packed_fma_per_pair"] = 2;
    result["probability_word_schedule"] =
        "native_first_adjacent_degree2_two_words_then_e4m3_v2_store";
    ...
    result["score_tmem_reuse_gate"] =
        "eight_warp_collective_after_second_half_tmem_load_before_native_d2p2_replay";

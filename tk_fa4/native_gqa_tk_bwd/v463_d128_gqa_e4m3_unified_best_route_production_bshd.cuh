...
#include "v460_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd.cuh"
...
// non-exact fallback are delegated to v460, which selects its owner-4
// compact-P/quarter-dP/fence-before-thread-sync/split-dV/direct-dK-dV kernel
// for exact B2, frozen v436 for non-exact B1, and frozen v437 for non-exact
// B2.  This router adds no device implementation and changes neither
// numerical operations nor launch geometry in any selected route.
namespace tkfa4::native_gqa_tk_bwd::v463_d128_gqa_e4m3_unified_best_route_production_bshd {
...
namespace b2_exact_and_fallbacks =
    tkfa4::native_gqa_tk_bwd::v460_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd;
...
inline void launch(
    ...
    // v460 selects exact B2's quarter-dP/split-dV owner-4/direct-dK-dV
    // kernel, frozen v436 for non-exact B1, and frozen v437 for non-exact B2.

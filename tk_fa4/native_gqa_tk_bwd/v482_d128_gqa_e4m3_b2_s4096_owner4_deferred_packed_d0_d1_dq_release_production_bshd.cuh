...
// B2/S4096 bounded dQ register-drain experiment derived only from v480.
...
// issue the paired D2/D3 x32 loads.  Release the aliased TMEM page before the
// ordered D0/D1 and unchanged D2/D3 shared stores.  B1 falls back to v436;
// other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v482_d128_gqa_e4m3_b2_s4096_owner4_deferred_packed_d0_d1_dq_release_production_bshd {

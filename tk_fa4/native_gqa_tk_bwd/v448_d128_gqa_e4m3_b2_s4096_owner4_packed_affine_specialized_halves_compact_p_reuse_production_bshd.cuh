...
// Isolated B2/S4096 experiment derived from frozen v446.  Keep its packed
// FP32x2 score/lstat affine and v443's owner-4/direct-dK-dV, exact rounded-
// E4M3 compact-P schedule, but specialize each column half at compile time.
// The specialization is intended to prevent ptxas from tail-merging both
// probability calls into one dynamically repeated path.  B1 falls back to
// v436; other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v448_d128_gqa_e4m3_b2_s4096_owner4_packed_affine_specialized_halves_compact_p_reuse_production_bshd {

...
// B2/S4096 synchronization-elision experiment derived only from frozen v465.
...
// and all numerical operations.  lstat/dstat are read only by compute;
// aggregate ds_ready precedes dK, and per-stage operand_consumed is published
// only after dK/dV completion.  Therefore the loader's later stats-consumed
// wait is redundant.  B1 falls back to v436; other B2 sequence lengths fall
// back to v437.
namespace tkfa4::native_gqa_tk_bwd::v466_d128_gqa_e4m3_b2_s4096_owner4_operand_gated_stats_reuse_production_bshd {

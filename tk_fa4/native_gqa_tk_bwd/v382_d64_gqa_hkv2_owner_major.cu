#include "v382_d64_gqa_hkv2_owner_major.cuh"
...
namespace owner =
    tkfa4::native_gqa_tk_bwd::v382_d64_hkv2_owner_major;
...
void check_common(
    ...
    TORCH_CHECK(
        ...
        "V382 D64 GQA owner-major two-head backward requires SM100"
    );
    TORCH_CHECK(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, module) {
    module.def(
        "backward_bf16",
        &backward_bf16,
        "V382 D64 GQA BF16 backward, owner-major two-head BSHD"
    );
    module.def(
        "backward_bf16_precomputed",
        &backward_bf16_precomputed,
        "V382 D64 GQA owner-major two-head BSHD backward with delta"
    );
}

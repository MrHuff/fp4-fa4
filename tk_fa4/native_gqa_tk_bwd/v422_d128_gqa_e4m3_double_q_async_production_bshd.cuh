...
// D128 production backward with a two-stage Q/dO/statistics pipeline.  GB200
// exposes 233,472 bytes of shared memory per SM and the authenticated CuTe
// comparator uses 150,528 bytes, so the ~146-KiB user allocation here is a
// valid one-CTA schedule.  P and dS stay distinct and single-buffered; exact
// phase-counted reader gates protect their reuse.
namespace tkfa4::native_gqa_tk_bwd::v422_d128_gqa_e4m3_double_q_async_production_bshd {
...
inline void launch(
    ...
    v422_d128_gqa_e4m3_double_q_async_production_bshd::main_kernel<<<
        grid,
        kThreads,
        0,
        stream

...
// B2/S4096 sequential owner-2 experiment combining v437's retained K/V and
// FP32 dK/dV ownership with v436's exact sequence schedule and runtime first
// E4M3 gradient-MMA accumulate predicate.  B1 and non-S4096 shapes use v436.
namespace tkfa4::native_gqa_tk_bwd::v438_d128_gqa_e4m3_b2_owner2_exact_s4096_production_bshd {
...
void owner2_exact_s4096_kernel(const __grid_constant__ globals g) {
...
inline void launch(
    ...
    owner2_exact_s4096_kernel<<<grid, kThreads, 0, stream>>>(g);

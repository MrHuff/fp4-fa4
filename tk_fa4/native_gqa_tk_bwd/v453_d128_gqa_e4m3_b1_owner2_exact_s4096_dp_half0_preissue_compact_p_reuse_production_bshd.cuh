...
// B1/S4096 dP-load scheduling experiment derived from frozen v445.  Preserve
// its owner-2 retained K/V, additive dQ/dK/dV publication, exact rounded-E4M3
// compact-P reuse, fallbacks, and numerical operations.  Apply only v447's
// safe first-half dP TMEM schedule: acquire and issue immediately after
// dp_ready, overlap the prior-dQ/dK waits, then wait at the original dS
// consumer.  Half 1 remains unchanged.
namespace tkfa4::native_gqa_tk_bwd::v453_d128_gqa_e4m3_b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_production_bshd {
...
__device__ __forceinline__ void consume_ds_half_compact(
    ...
    // The wait remains at v445's original first dS consumer point.
    tensor_load_wait();
...
void b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_kernel(const __grid_constant__ globals g) {
...
inline void launch(
    ...
    b1_owner2_exact_s4096_dp_half0_preissue_compact_p_reuse_kernel<<<grid, kThreads, 0, stream>>>(g);

#include "v454_d128_gqa_e4m3_unified_best_route_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v454_d128_gqa_e4m3_unified_best_route_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v454 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v454 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v454_d128_gqa_e4m3_unified_best_route_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "thin_frozen_dispatch_B1_S4096_v445_owner2_compact_probability_"
        "B2_S4096_v447_owner4_compact_probability_half0_dp_preissue_"
        "direct_dkdv_B1_other_v436_B2_other_v437";
    ...
    result["b2_s4096_route"] =
        "v447_owner4_compact_p_half0_dp_preissue_additive_dq_"
        "unique_direct_dkdv";

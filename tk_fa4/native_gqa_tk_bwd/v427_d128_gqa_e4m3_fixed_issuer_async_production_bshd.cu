#include "v427_d128_gqa_e4m3_fixed_issuer_async_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v427_d128_gqa_e4m3_fixed_issuer_async_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v427 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v424 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v427_d128_gqa_e4m3_fixed_issuer_async_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "mbarrier_d32x2_publication_fixed_lane0_tcgen_issuer";
    ...
    result["derived_from"] =
        "v424_d128_gqa_e4m3_score_release_async_production_bshd";
    result["tensor_issuer"] =
        "physical_warp_12_lane_0_direct_fixed_k128_q128_tcgen";
    result["tensor_issuer_source_nested_lane_guard"] = false;
    result["tensor_issuer_sass_election_replay"] =
        "retained_by_ptxas_single_thread_tcgen_lowering";
    result["static_optimization_disposition"] =
        "zero_selected_sass_delta_vs_v424";
    result["tensor_issuer_descriptor_binding"] =
        "fixed_exact_N_T_views_at_direct_tcgen_call_sites";
    ...
    result["gradient_publication_wait_policy"] =
        "read_wait_1_before_same_stage_reuse_final_wait_0";
    ...
    result["dp_dq_alias_gate"] =
        "four_warp_collective_dq_drained_after_final_d32_tmem_load";
    result["dp_next_schedule"] =
        "immediately_after_dq_drained_before_current_dk_dv_release_wait";
    result["tmem_map"] =
        "dp_dq_0_128_dk_128_256_dv_256_384_score_384_512";
    result["gradient_drain"] =
        "four_reducer_warps_cooperative_128x32_four_depth_chunks";

...
// B2/S4096 dP-load scheduling experiment derived byte-for-source from frozen
// v443.  Preserve v443's owner-4/direct-dK-dV schedule and exact rounded E4M3
// P reuse.  Only first-half dP TMEM loading changes: issue immediately after
// dp_ready, overlap the existing prior-dQ/dK waits, and wait at the original
// first dS consumer.  Half 1 and all numerical operations remain unchanged.
// B1 falls back to v436; other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v447_d128_gqa_e4m3_b2_s4096_owner4_dp_half0_preissue_compact_p_reuse_production_bshd {

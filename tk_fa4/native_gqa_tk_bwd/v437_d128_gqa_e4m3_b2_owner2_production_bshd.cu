...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v437 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v437 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v437_d128_gqa_e4m3_b2_owner2_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "b2_flat_batch_head_pair_fast_owner2_retained_kv_fp32_dkdv_"
        "private_dq_b1_v433_fallback";
    ...
    result["batch_dispatch"] = "B2_owner2_B1_v433";
    ...
    result["owner2_dkdv_policy"] =
        "fp32_tmem_accumulate_two_heads_then_pair_additive_tma";

...
#include "v422_d128_gqa_e4m3_double_q_async_production_bshd.cuh"
...
// with the forward-derived packed degree-2 approximation while the SFU is in
// flight, then immediately converts and publishes the four E4M3 values.
namespace tkfa4::native_gqa_tk_bwd::v423_d128_gqa_e4m3_d2p2_async_production_bshd {

namespace predecessor =
    tkfa4::native_gqa_tk_bwd::v422_d128_gqa_e4m3_double_q_async_production_bshd;
namespace core =
...
__device__ __forceinline__ uint32_t probability_word_d2p2(
    ...
    // Start the native pair before doing the independent degree-2 range
...
inline void launch(
    ...
    v423_d128_gqa_e4m3_d2p2_async_production_bshd::main_kernel<<<
        grid,
        kThreads,
        0,
        stream

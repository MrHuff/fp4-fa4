#include "v451_d128_gqa_e4m3_b1_s4096_owner4_compact_p_reuse_direct_dkdv_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v451_d128_gqa_e4m3_b1_s4096_owner4_compact_p_reuse_direct_dkdv_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v451 tensors must share batch/sequence and gradient shapes"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v451_d128_gqa_e4m3_b1_s4096_owner4_compact_p_reuse_direct_dkdv_production_bshd_v1";
    result["source_file"] = __FILE__;
    result["topology"] =
        "b1_s4096_owner4_exact_runtime_compact_rounded_e4m3_p_"
        "direct_dkdv_all_other_shapes_v442";
    ...
    result["backward_out_physical_clear_policy"] =
        "dq_always_dkdv_except_unique_writer_B1_or_B2_S4096_owner4";
    ...
    result["selected_device_kernel"] = "v443::owner4_kernel";
    result["causal"] = true;
    ...
    result["batch_dispatch"] =
        "B1_S4096_v443_owner4_compact_direct_all_other_shapes_v442";

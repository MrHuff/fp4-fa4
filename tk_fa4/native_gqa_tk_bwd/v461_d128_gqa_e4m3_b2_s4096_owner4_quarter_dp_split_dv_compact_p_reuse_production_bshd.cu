#include "v461_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v461_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v461 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v461 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v461_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd_v1";
    ...
    result["dp_half0_tmem_schedule"] =
        ...
        "issue_chunk1_warp_sync_consume_chunk0_wait_chunk1_consume_chunk1";

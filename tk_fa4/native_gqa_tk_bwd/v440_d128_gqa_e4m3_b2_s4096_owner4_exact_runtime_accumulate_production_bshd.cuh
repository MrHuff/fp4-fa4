...
// B2/S4096 sequential owner-4 experiment derived from validated v437 and
// exact/runtime-predicate v436.  One CTA owns all four query heads of one KV
// head, retaining K/V and FP32 dK/dV while dQ remains private per query head.
// B1 falls back to v436; other B2 sequence lengths fall back to v437.
namespace tkfa4::native_gqa_tk_bwd::v440_d128_gqa_e4m3_b2_s4096_owner4_exact_runtime_accumulate_production_bshd {

#include "v428_d128_gqa_e4m3_owner_dq_evacuation_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v428_d128_gqa_e4m3_owner_dq_evacuation_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v428 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v428 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v428_d128_gqa_e4m3_owner_dq_evacuation_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "mbarrier_owner_x32_fp32_dq_evacuation_d32x2_publication";
    ...
    result["dp_dq_alias_gate"] =
        "four_warp_collective_after_complete_owner_x32_fp32_evacuation";
    result["dp_next_schedule"] =
        "after_full_dq_tmem_evacuation_before_bf16_conversion_and_tma";
    result["tmem_map"] =
        "dp_dq_0_128_dk_128_256_dv_256_384_score_384_512";
    result["gradient_drain"] =
        "four_owner_warps_x32_to_shared_fp32_then_bf16_d32_publication";
    result["dq_evacuation_dtype"] = "float32";
    result["dq_evacuation_shape"] = "128x128";
    result["dq_tmem_load_opcode"] =

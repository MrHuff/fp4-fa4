#include "v457_d128_gqa_e4m3_b2_s4096_owner4_split_dv_interleaved_exp2_pack_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v457_d128_gqa_e4m3_b2_s4096_owner4_split_dv_interleaved_exp2_pack_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v457 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v457 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v457_d128_gqa_e4m3_b2_s4096_owner4_split_dv_interleaved_exp2_pack_compact_p_reuse_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "compact_rounded_e4m3_p_register_reuse_interleaved_exact_"
        "exp2_pack_publication_split_dv_k32_halves_b1_v436_other_b2_v437";
    ...
    result["probability_exp2_pack_schedule"] =
        "four_float2_pairs_then_exact_e4m3_wordpair_v2_shared_store";
    result["probability_numerics_parent"] =
        "v455_exact_native_exp2_clamp_and_e4m3_rounding";
    result["dp_half0_tmem_schedule"] =
        "issue_after_dp_ready_before_previous_dq_dk_waits_then_wait_at_ds";

...
// B2/S4096 sequential owner-2 experiment reusing v445's retained K/V,
...
// publication through dS.  All other shapes retain v437's dynamic owner-2
// B2 path and its v433 B1 fallback.
namespace tkfa4::native_gqa_tk_bwd::v452_d128_gqa_e4m3_b2_owner2_exact_s4096_compact_p_reuse_production_bshd {
...
void b2_owner2_exact_s4096_compact_p_reuse_kernel(const __grid_constant__ globals g) {
...
inline void launch(
    ...
    if (q.size(0) != 2 || q.size(1) != kExactSequence) {
        fallback::launch(
            q,
            k,
            v,
    ...
    b2_owner2_exact_s4096_compact_p_reuse_kernel<<<grid, kThreads, 0, stream>>>(g);

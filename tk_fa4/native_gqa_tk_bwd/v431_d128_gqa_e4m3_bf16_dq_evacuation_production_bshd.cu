...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v431 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v431 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v431_d128_gqa_e4m3_bf16_dq_evacuation_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "mbarrier_owner_x32_full_bf16_dq_evacuation_d32x4_single_"
        "buffer_dk_dv_d32x2_publication";
    ...
    result["gradient_publication_wait_policy"] =
        "dq_single_buffer_read_wait_0_before_reuse_dk_dv_d32x2_"
    ...
    result["dp_dq_alias_gate"] =
        "four_warp_collective_after_four_d32_x32_wait_pack_store_fence";
    ...
    result["gradient_drain"] =
        "dq_four_owner_warps_x32_immediate_bf16_full_shared_"
        "evacuation_dk_dv_owner_x32_direct_d32_publication";
    result["gradient_tmem_load_opcode"] =
        "tcgen05.ld.sync.aligned.32x32b.x32.b32";
    result["gradient_tmem_load_wait"] =
        "immediately_after_every_raw_x32_load";
    result["gradient_intermediate_shared_dtype"] = "dq_bfloat16";
    result["dq_evacuation_shape"] = "4x128x32";
    result["dq_evacuation_bytes"] =
        static_cast<int>(sizeof(candidate::gradient_chunk_tile) *
                         candidate::kDepthChunks);
    result["dq_evacuation_reuse_gate"] =
        "warp0_lane0_read_wait_0_then_count1_mbarrier_all_four_warps";

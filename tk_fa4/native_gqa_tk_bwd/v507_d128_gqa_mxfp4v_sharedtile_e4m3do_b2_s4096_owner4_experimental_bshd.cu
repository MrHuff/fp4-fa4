#include "v507_d128_gqa_mxfp4v_sharedtile_e4m3do_b2_s4096_owner4_experimental_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v507_d128_gqa_mxfp4v_sharedtile_e4m3do_b2_s4096_owner4_experimental_bshd;
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v507 shared-tile MXFP4-V backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["schema"] = "tkfa4.native_tk_d128_backward.experimental.v3";
    ...
    result["required_data_abi"] =
        ...
        "register_transpose";
    result["required_projection_symbol"] =
    ...
    result["eliminates_duplicate_v_quantization"] = true;
    result["producer_reuses_forward_quantization"] = true;
    result["producer_shared_tile_shape"] = "D32xS32";
    result["producer_scale_policy"] =
        "one_independent_E8M0_anchor_per_D32xS32_tile";
    result["producer_payload_transform"] =
        "register_transpose_exact_forward_E2M1_nibbles";
    result["producer_second_bf16_scan"] = false;
    result["producer_second_e2m1_quantization"] = false;
    result["producer_v_mxfp4_scale_2d"] = true;
    result["v_scale_slot_mapping"] =
        "row_in_32*16+sequence_quarter*4+depth_group";
    ...
    result["dp_scale_slots"] =
        "SFID_0_1_2_3_select_four_independent_D32_anchors";
    ...
    result["score_scale_tmem_alias"] =
        "score_columns_384_415_guarded_by_dp_ready_before_score_and_"
        "score_consumed_before_scale_restage_including_head_boundary";
    result["tensor_issue_schedule"] =
        "next_score_after_current_dp_ready_during_P1_dS;_next_scales_after_"
        "next_score_consumed_during_current_dq_drain;_next_dp_after_current_"
        "dq_tmem_drained";
    ...
    result["scale_restage_overlap"] = "current_dq_tmem_drain";
    ...
    result["shared_memory_receipt"] =
        "inherits_v502_static_shared_layout_expected_168208B;_verify_actual_"
        "ptxas_at_build";

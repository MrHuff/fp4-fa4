#include "v462_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v462_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v462 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v462 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v462_d128_gqa_e4m3_b2_s4096_owner4_quarter_dp_split_dv_compact_p_reuse_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "split_dv_k32_halves_chunk1_tensor_proxy_fence_warpsync_"
    ...
    result["dp_half0_tmem_schedule"] =
        ...
        "issue_chunk1_tensor_before_thread_sync_warpsync_"
        "consume_chunk0_wait_chunk1_consume_chunk1";
    result["dp_half0_chunk1_ordering"] =
        "tensor_before_thread_sync_immediately_then_syncwarp_"
        "before_chunk0_shared_stats_load_and_affine";

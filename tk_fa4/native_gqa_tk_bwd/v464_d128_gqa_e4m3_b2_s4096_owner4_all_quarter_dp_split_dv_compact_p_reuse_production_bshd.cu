#include "v464_d128_gqa_e4m3_b2_s4096_owner4_all_quarter_dp_split_dv_compact_p_reuse_production_bshd.cuh"
...
namespace candidate =
    tkfa4::native_gqa_tk_bwd::v464_d128_gqa_e4m3_b2_s4096_owner4_all_quarter_dp_split_dv_compact_p_reuse_production_bshd;
...
void check_arguments(
    ...
    TORCH_CHECK(
        ...
        "v464 tensors must share batch/sequence and gradient shapes"
    );
...
void launch_checked(
    ...
    TORCH_CHECK(
        ...
        "v464 production-BSHD D128 GQA backward requires SM100"
    );
...
pybind11::dict metadata() {
    ...
    result["source_identity"] =
        "v464_d128_gqa_e4m3_b2_s4096_owner4_all_quarter_dp_split_dv_compact_p_reuse_production_bshd_v1";
    ...
    result["topology"] =
        ...
        "compact_rounded_e4m3_p_register_reuse_all_quarter_dp_"
        "split_dv_k32_halves_"
    ...
    result["dp_half0_tmem_schedule"] =
        "x16_chunk0_issue_before_previous_dq_dk_waits_wait_chunk0_"
        "issue_chunk1_fence_before_thread_sync_consume_chunk0_"
        "wait_chunk1_consume_chunk1";
    result["dp_chunk1_issue_anchor"] =
        "both_halves_tcgen05_fence_before_thread_sync_only_no_warp_sync";
    result["dp_half0_chunk_mapping"] =
        "owner_aligned_chunk0_cols_0_15_32_47_chunk1_cols_16_31_48_63";
    result["dp_half1_tmem_schedule"] =
        "x16_chunk0_issue_wait_chunk0_issue_chunk1_"
        "fence_before_thread_sync_consume_chunk0_wait_chunk1_consume_chunk1";
    result["dp_half1_chunk_mapping"] =
        "owner_aligned_chunk0_cols_64_79_96_111_"
        "chunk1_cols_80_95_112_127";
